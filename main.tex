...
The answer is remarkably simple: under a maximum-entropy (configuration-model) ensemble consistent with observed value marginals, the ensemble mean of the exact posterior depends on the unknown entity side only through a single scalar---the across-entity degree variance~$\sigma^2$.
