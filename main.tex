...
That $P(S\mid\coll)$ reduces to the degree variance $\sigma^2$ is therefore not a deep technical achievement---it is a short bridge between two fields that have not previously been connected in this way.
